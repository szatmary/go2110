...
- **Entire roadmap (items 1–8) complete.** All 11 packages build, vet clean, and
  pass tests on `main`:
  - `rtp` (RFC 3550 + RFC 8285), `sdp` (RFC 4566 + RFC 7273 2110 attributes).
  - `st2110/media` (timing), `st2110/video` (2110-20), `st2110/audio` (2110-30),
    `st2110/anc` (2110-40 / RFC 8331), `st2110/timing21` (2110-21),
    `st2110/aes3` (2110-31), `st2110/cv22` (2110-22), `st2110/fastmeta`
    (2110-41), `st2110/ttml` (2110-43 / RFC 8759).
